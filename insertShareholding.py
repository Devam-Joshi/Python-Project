...
def insert_main(r,j):
    ...
    while(ins<key_length):    
        add_val="insert into {tname}_shareholding values ('{k}','{r1}','{r2}','{r3}','{r4}','{r5}')".format(tname=j, k=key[ins],r1=sp1[ins],r2=sp2[ins],r3=sp3[ins],r4=sp4[ins],r5=sp5[ins])
        ins=ins+1
        print(add_val)
